...
urlpatterns = [
    ...
    path("finans/banka/ekle/", views.banka_hesap_ekle, name="banka_hesap_ekle"),
    path("finans/banka/<int:pk>/duzenle/", views.banka_hesap_duzenle, name="banka_hesap_duzenle"),
    path("finans/banka/<int:pk>/sil/", views.banka_hesap_sil, name="banka_hesap_sil"),
