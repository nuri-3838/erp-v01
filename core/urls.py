...
urlpatterns = [
    ...
    path("faturalar/<int:pk>/sil/", views.fatura_sil_gorunum, name="fatura_sil"),
    path("faturalar/<int:pk>/onayla/", views.fatura_onayla, name="fatura_onayla"),
    path("satinalma/teklifler/", views.satinalma_teklifleri, name="satinalma_teklifleri"),
    path("satinalma/teklifler/ekle/", views.satinalma_teklif_ekle, name="satinalma_teklif_ekle"),
    path("satinalma/siparisler/", views.satinalma_siparisleri, name="satinalma_siparisleri"),
    path("satinalma/siparisler/ekle/", views.satinalma_siparis_ekle, name="satinalma_siparis_ekle"),
    path("satinalma/irsaliyeler/", views.satinalma_irsaliyeleri, name="satinalma_irsaliyeleri"),
    ...
    path("satis/proformalar/", views.satis_proformalari, name="satis_proformalari"),
    path("satis/proformalar/ekle/", views.satis_proforma_ekle, name="satis_proforma_ekle"),
    path("satis/proformalar/<int:pk>/duzenle/", views.satis_proforma_duzenle,
         name="satis_proforma_duzenle"),
    ...
    path("teklif-siparis/<int:pk>/onayla/", views.teklif_siparis_onayla, name="teklif_siparis_onayla"),
    path("teklif-siparis/<int:pk>/onayi-geri-al/", views.teklif_siparis_onayi_geri_al, name="teklif_siparis_onayi_geri_al"),
    path("teklif-siparis/<int:pk>/pdf/", views.teklif_siparis_pdf, name="teklif_siparis_pdf"),
    path("teklif-siparis/<int:pk>/proformaya-cevir/", views.teklif_proformaya_cevir,
         name="teklif_proformaya_cevir"),
    path("teklif-siparis/<int:pk>/proforma-siparise-cevir/", views.proforma_siparise_cevir,
         name="proforma_siparise_cevir"),
    path("teklif-siparis/<int:pk>/faturaya-cevir/", views.siparis_faturaya_cevir, name="siparis_faturaya_cevir"),
    path("teklif-siparis/<int:pk>/uretim-emrine-cevir/", views.siparis_uretim_emrine_cevir,
         name="siparis_uretim_emrine_cevir"),
    ...
    path("uretim/istasyonlar/<int:pk>/duzenle/", views.is_istasyonu_duzenle,
         name="is_istasyonu_duzenle"),
    path("uretim/istasyonlar/<int:pk>/sil/", views.is_istasyonu_sil, name="is_istasyonu_sil"),
    path("uretim/operasyonlar/", views.operasyon_tanimlari, name="operasyon_tanimlari"),
    path("uretim/operasyonlar/ekle/", views.operasyon_ekle, name="operasyon_ekle"),
    path("uretim/operasyonlar/<int:pk>/duzenle/", views.operasyon_duzenle,
    ...
    path("ayarlar/tanimlar/secenek/<slug:slug>/", views.secenek_listesi, name="secenek_listesi"),
    ...
    path("finans/cek-senet/<int:pk>/gorsel/<str:yuz>/", views.cek_gorsel, name="cek_gorsel"),
    ...
    path("cariler/<int:cari_pk>/sevk-adresi/ekle/", views.sevk_adresi_ekle, name="sevk_adresi_ekle"),
    path("cariler/sevk-adresi/<int:pk>/duzenle/", views.sevk_adresi_duzenle, name="sevk_adresi_duzenle"),
    path("cariler/sevk-adresi/<int:pk>/sil/", views.sevk_adresi_sil, name="sevk_adresi_sil"),
    ...
    path("cariler/<int:cari_pk>/aktivite/ekle/", views.aktivite_ekle, name="aktivite_ekle"),
    path("cariler/aktivite/<int:pk>/duzenle/", views.aktivite_duzenle, name="aktivite_duzenle"),
    path("cariler/aktivite/<int:pk>/sil/", views.aktivite_sil, name="aktivite_sil"),
    path("cariler/aktivite/ek/<int:pk>/sil/", views.aktivite_ek_sil, name="aktivite_ek_sil"),
    path("cariler/aktivite/ek/<int:pk>/indir/", views.cari_ek_indir, name="cari_ek_indir"),
    path("crm/kategoriler/", views.aday_kategoriler, name="aday_kategoriler"),
    path("crm/kategoriler/ekle/", views.aday_kategori_ekle, name="aday_kategori_ekle"),
    path("crm/kategoriler/<int:pk>/duzenle/", views.aday_kategori_duzenle,
         name="aday_kategori_duzenle"),
    path("crm/kategoriler/<int:pk>/sil/", views.aday_kategori_sil, name="aday_kategori_sil"),
    path("crm/adaylar/", views.aday_musteriler, name="aday_musteriler"),
    path("crm/adaylar/ekle/", views.aday_musteri_ekle, name="aday_musteri_ekle"),
    path("crm/adaylar/<int:pk>/", views.aday_musteri_detay, name="aday_musteri_detay"),
    path("crm/adaylar/<int:pk>/duzenle/", views.aday_musteri_duzenle, name="aday_musteri_duzenle"),
    path("crm/adaylar/<int:pk>/sil/", views.aday_musteri_sil, name="aday_musteri_sil"),
    path("crm/adaylar/<int:pk>/cariye-donustur/", views.aday_cariye_donustur,
         name="aday_cariye_donustur"),
    path("crm/adaylar/<int:aday_pk>/aktivite/ekle/", views.aday_aktivite_ekle,
         name="aday_aktivite_ekle"),
    ...
    path("crm/aktivite/ek/<int:pk>/indir/", views.aday_ek_indir, name="aday_ek_indir"),
    ...
    path("ik/personel/", views.personeller, name="personeller"),
    path("ik/personel/ekle/", views.personel_ekle, name="personel_ekle"),
    ...
    path("ik/belgeler/", views.belgeler, name="belgeler"),
    path("ik/belgeler/suresi-dolacaklar/", views.belge_uyarilari, name="belge_uyarilari"),
    path("ik/belgeler/ekle/", views.belge_ekle, name="belge_ekle"),
    path("ik/belgeler/<int:pk>/duzenle/", views.belge_duzenle, name="belge_duzenle"),
    path("ik/belgeler/<int:pk>/sil/", views.belge_sil, name="belge_sil"),
    path("ik/belgeler/<int:pk>/indir/", views.belge_indir, name="belge_indir"),
    path("ik/personel/<int:pk>/foto/", views.personel_foto, name="personel_foto"),
    path("ik/personel/<int:pk>/foto/yukle/", views.personel_foto_yukle, name="personel_foto_yukle"),
