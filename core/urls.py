...
urlpatterns = [
    ...
    path("finans/cek-senet/<int:pk>/islem/<str:islem>/", views.cek_senet_islem, name="cek_senet_islem"),
    path("finans/cek-senet/<int:pk>/islem-geri-al/", views.cek_senet_islem_geri_al, name="cek_senet_islem_geri_al"),
